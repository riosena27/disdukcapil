        ...
        <form action="{{url('register')}}" method="post">
            ...
            <div class="row" style="margin:0">
                <div class="input-field col s6">
                    ...
                    <span class="helper-text left-align" data-error="Masukkan NIK anda yang valid">NIK pada ktp.</span>
                </div>
                <div class="input-field col s6">
                    <input id="nik_kk" type="number" name="nik_kk" class="validate" data-length="16">
                    <label for="nik_kk">NIK *KK*</label>
                    <span class="helper-text left-align" data-error="Masukkan NIK KK anda yang valid">NIK pada kartu keluarga.</span>
                </div>
            </div>
            ...
            <div class="row" style="margin-left:0;margin-right:0">
                <div class="input-field col s12">
                    ...
                    <span class="helper-text left-align" data-error="Nama anda terlalu singkat">Berikan nama lengkap anda.</span>
                </div>
            </div>
            ...
            <div class="row" style="margin:0">
                <div class="input-field col s12">
                    ...
                    <span class="helper-text left-align" data-error="cth: 0812214214"
                    >Gunakan nomor handphone anda yang sedang aktif.</span>
                </div>
