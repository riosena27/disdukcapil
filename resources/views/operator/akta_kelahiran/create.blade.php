            ...
            <div class="card-content">
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Surat Keterangan Lahir:</p> <a href="">{{$akta->surat_keterangan_lahir}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Kartu Keluarga:</p> <a href="">{{$akta->kartu_keluarga}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Akta Orang Tua:</p> <a href="">{{$akta->keterangan_akta_orang_tua}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>SPTJM Pasutri:</p> <a href="">{{$akta->sptjm_pasutri}}</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Permohonan Kelahiran:</p> <a
                            href="">{{$akta->keterangan_permohonan_kelahiran}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>SPTJM Kebenaran Kelahiran:</p> <a href="">{{$akta->sptjm_kebenaran_kelahiran}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Anak Kawin:</p> <a href="">{{$akta->keterangan_anak_kawin}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Pernyataan Saksi:</p> <a href="">{{$akta->pernyataan_saksi}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>KTP Saksi Kelahiran(Balikpapan):</p> <a href="">{{$akta->ktp_saksi_balikpapan}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Surat Kuasa(Jika Diwakilkan):</p> <a href="">{{$akta->surat_kuasa}}</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Fotocopy Akta Anak Sebelumnya (jika anak kedua):</p> <a
                            href="">{{$akta->fotocopy_akta_anak}}</a>
                    </div>
                </div>
