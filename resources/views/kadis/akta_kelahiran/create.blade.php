    ...
    <div class="col s12">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="row">
                    <a href="{{url('kadis/akta-kelahiran')}}" class="waves-effect waves-light btn red left"><i
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Surat Keterangan Lahir:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->surat_keterangan_lahir)}}" target="_blank">{{$akta->surat_keterangan_lahir}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Kartu Keluarga:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->kartu_keluarga)}}" target="_blank">{{$akta->kartu_keluarga}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Akta Orang Tua:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->keterangan_akta_orang_tua)}}" target="_blank">{{$akta->keterangan_akta_orang_tua}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>SPTJM Pasutri:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->sptjm_pasutri)}}" target="_blank">{{$akta->sptjm_pasutri}}</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Permohonan Kelahiran:</p> <a
                            href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->keterangan_permohonan_kelahiran)}}" target="_blank">{{$akta->keterangan_permohonan_kelahiran}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>SPTJM Kebenaran Kelahiran:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->sptjm_kebenaran_kelahiran)}}" target="_blank">{{$akta->sptjm_kebenaran_kelahiran}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Keterangan Anak Kawin:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->keterangan_anak_kawin)}}" target="_blank">{{$akta->keterangan_anak_kawin}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Pernyataan Saksi:</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->pernyataan_saksi)}}" target="_blank">{{$akta->pernyataan_saksi}}</a>
                    </div>
                </div>

                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>KTP Saksi Kelahiran(Balikpapan):</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->ktp_saksi_balikpapan)}}" target="_blank">{{$akta->ktp_saksi_balikpapan}}</a>
                    </div>

                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Surat Kuasa(Jika Diwakilkan):</p> <a href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->surat_kuasa)}}" target="_blank">{{$akta->surat_kuasa}}</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="file-field input-field col s6" style="margin:0px">
                        <p>Fotocopy Akta Anak Sebelumnya (jika anak kedua):</p> <a
                            href="{{url('kadis/akta-kelahiran/'.$akta->id.'/open-pdf?pdf='.$akta->fotocopy_akta_anak)}}" target="_blank">{{$akta->fotocopy_akta_anak}}</a>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <form action="{{url('kadis/akta-kelahiran/'.$akta->id)}}" method="POST">
                    @method('put')
                    @csrf

                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="textarea2" class="materialize-textarea" name="review_kadis"
                                required></textarea>
                    ...
                    <label style="margin-right: 8px">
                        <input name="status_kadis" type="radio" value="3" required />
                        <span>Setuju</span>
                    </label>

                    <label>
                        <input name="status_kadis" type="radio" value="2" required />
                        <span>Tolak</span>
                    </label>
